      ...
      <section className="w-full h-full max-w-[1200px] my-10 shadow-md shadow-black/20 rounded-lg mx-auto text-black">
        <div className="w-full bg-zinc-100 max-w-[1200px] mx-auto flex flex-col border py-5">
          <div className="w-[73%] mx-auto flex justify-between items-center text-black/70">
            ...
            <h1 className="uppercase font-semibold">QTD</h1>
            <h1 className="uppercase font-semibold">Subtotal</h1>
          </div>

          {cart.length > 0 ? (
            cart.map((produto) => (
              <div key={produto.id} className="flex justify-between items-center px-8 mt-5 border-b py-2">
                <div className="flex items-center gap-4">
                  <img src={produto.img} className="size-28 rounded-full" alt={produto.title} />
                  <div className="flex flex-col">
                    <h1 className="font-semibold text-black/70">{produto.title}</h1>
            ...
            <div className="text-center text-black/70">Seu carrinho está vazio.</div>
          )}
          ...
          <div className="w-[80%] flex mx-auto mt-10 justify-between">
            ...
            <div className="text-lg font-bold uppercase text-zinc-600">
              Total: <span className="text-2xl text-black">{calculateTotal()}</span>
            </div>
          </div>
        </div>
      </section>
